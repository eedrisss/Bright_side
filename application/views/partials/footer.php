<footer class="bg-primary-3 text-white links-white pb-4 footer-1">
            ...
            <ul class="list-unstyled d-flex flex-wrap">
              <li class="col-12 col-lg-6 col-xl-12 px-0">
                <div class="row my-2 my-md-3">
                  <a class="col-5" href="#">
                    <img class="rounded img-fluid hover-fade-out" src="<?= base_url('assets/img/blog/thumb-2.jpg') ?>" alt="blog.1.image">
                  </a>
                  <div class="col">
              ...
              <li class="col-12 col-lg-6 col-xl-12 px-0">
                <div class="row my-2 my-md-3">
                  <a class="col-5" href="#">
                    <img class="rounded img-fluid hover-fade-out" src="<?= base_url('assets/img/blog/thumb-1.jpg') ?>" alt="blog.2.image">
                  </a>
                  <div class="col">
          ...
          <div class="col-lg mt-2 mt-md-5 mt-lg-0 order-lg-3 order-xl-4">
            ...
            <div class="card card-body bg-white">
              ...
              <form data-form-email novalidate action="/forms/mailchimp.php">
                ...
                <div data-sitekey="INSERT_YOUR_RECAPTCHA_V2_SITEKEY_HERE" data-size="invisible" data-badge="bottomleft"></div>
            ...
            <ul class="list-unstyled d-flex mb-0">
              <li class="mx-3">
                <a href="#" class="hover-fade-out">
                  <img src="<?= base_url('assets/img/icons/social/dribbble.svg') ?>" alt="Dribbble" class="icon icon-xs bg-white" data-inject-svg>
                </a>
              </li>
              <li class="mx-3">
                <a href="#" class="hover-fade-out">
                  <img src="<?= base_url('assets/img/icons/social/twitter.svg') ?>" alt="Twitter" class="icon icon-xs bg-white" data-inject-svg>
                </a>
              </li>
              <li class="mx-3">
                <a href="#" class="hover-fade-out">
                  <img src="<?= base_url('assets/img/icons/social/github.svg') ?>" alt="Github" class="icon icon-xs bg-white" data-inject-svg>
                </a>
              </li>
              <li class="mx-3">
                <a href="#" class="hover-fade-out">
                  <img src="<?= base_url('assets/img/icons/social/facebook.svg') ?>" alt="Facebook" class="icon icon-xs bg-white" data-inject-svg>
                </a>
              </li>
              <li class="mx-3">
                <a href="#" class="hover-fade-out">
                  <img src="<?= base_url('assets/img/icons/social/google.svg') ?>" alt="Google" class="icon icon-xs bg-white" data-inject-svg>
                </a>
              </li>
            </ul>
          </div>
    ...
    <script type="text/javascript" src="<?= base_url('assets/js/jarallax.min.js') ?>"></script>
    <script type="text/javascript" src="<?= base_url('assets/js/jarallax-video.min.js') ?>"></script>
    <script type="text/javascript" src="<?= base_url('assets/js/jarallax-element.min.js') ?>"></script>
    ...
    <script type="text/javascript" src="<?= base_url('assets/js/plyr.polyfilled.min.js') ?>"></script>
    <!-- Prism (displays formatted code boxes) -->
    <script type="text/javascript" src="<?= base_url('assets/js/prism.js') ?>"></script>
    <!-- ScrollMonitor (manages events for elements scrolling in and out of view) -->
    <script type="text/javascript" src="<?= base_url('assets/js/scrollMonitor.js') ?>"></script>
    <!-- Smooth scroll (animation to links in-page)-->
    <script type="text/javascript" src="<?= base_url('assets/js/smooth-scroll.polyfills.min.js') ?>"></script>
    <!-- SVGInjector (replaces img tags with SVG code to allow easy inclusion of SVGs with the benefit of inheriting colors and styles)-->
    <script type="text/javascript" src="<?= base_url('assets/js/svg-injector.umd.production.js') ?>"></script>
    <!-- TwitterFetcher (displays a feed of tweets from a specified account)-->
    <script type="text/javascript" src="<?= base_url('assets/js/twitterFetcher_min.js') ?>"></script>
    <!-- Typed text (animated typing effect)-->
    <script type="text/javascript" src="<?= base_url('assets/js/typed.min.js') ?>"></script>
